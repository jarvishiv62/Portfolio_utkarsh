...
const MARQUEE_ITEMS = [
  "laravel sorcerer", "·", "next.js builder", "·", "api optimizer", "·",
  "30% faster", "·", "ships on time", "·", "reads the docs", "·",
  "available 2026", "·", "bareilly represent", "·",
];
      ...
      <div className="max-w-6xl mx-auto px-5 py-10 grid grid-cols-1 md:grid-cols-3 gap-8">
        ...
        <div>
          ...
          <ul className="space-y-2">
            {[
              { label: "virmauryauttu@gmail.com", href: `mailto:${SITE.email}` },
              ...
              <li key={href}>
                <a
                  ...
                  style={{ color: "var(--text-muted)", fontFamily: href.includes("@") ? "var(--font-mono)" : "inherit" }}
                >
                  {label}
                </a>
              </li>
