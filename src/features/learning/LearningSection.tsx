  ...
  return (
    <section id="learning" className="section-pad">
      <div className="max-w-6xl mx-auto">
        ...
        <FadeIn delay={0.1}>
          <p
            className="mt-3 mb-8 text-sm"
            style={{ color: "var(--text-muted)" }}
          >
            not a list of things i watched a youtube video about. these are
            things i&apos;m actively breaking and fixing right now.
          </p>
        </FadeIn>
